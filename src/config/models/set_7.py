...
class ActivoPrecisionIntermediaStrExt(BaseModel):
    ...
    rsd_an1_an2: float = Field(..., description="RSD de los porcentajes obtenidos del activo evaluado en el parametro de precision del metodo")
    promedio_an1: float = Field(..., description="Promedio de los porcentajes obtenidos del activo evaluado en el parametro de precision del metodo")
    promedio_an2: float = Field(..., description="Promedio de los porcentajes obtenidos del activo evaluado en el parametro de precision del metodo")
