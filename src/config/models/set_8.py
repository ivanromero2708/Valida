...
class DataReplicaEstabilidadSoluciones(BaseModel):
    replica: int = Field(..., description="Réplica del dato de estabilidad de las soluciones, es un entero que inicia en 1 hacia adelante, se encuentra reportado como Solucion Estandar R1, Solucion Estandar R2, Solucion Estandar R3 para cada condicion 1 y 2 y cada tiempo de estabilidad")
    area: float = Field(..., description="Área bajo la curva del pico asociado al dato de validación de la estabilidad de las soluciones, reportados en las columnas de los difrentes tiempos de estabilidad Initial Sample Stability, Sample Stability Time 1... como Results asociados con cada Solucion Estandar R1 .. de cada condicion 1 y 2")
 
class DataEstabilidadSoluciones(BaseModel):
    """Modelo de validación de datos de la estabilidad de las soluciones"""    
    condicion_estabilidad: str = Field(..., description="Condición de almacenamiento de las soluciones para validación de su estabilidad, reportada para cada tiempo de estabilidad como Solucion  Estandar R1 Condicion 1, Solucion Estandar R2 Condicion 1, Solucion Estandar R3 Condicion 1, Solucion Estandar R1 Condicion 2, Solucion Estandar R2 Condicion 2, Solucion Estandar R3 Condicion 2, para cada uno de los tiempos evaluados.")
